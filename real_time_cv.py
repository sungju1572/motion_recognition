    ...
    while cv2.waitKey(1) < 0:
        ...
        for pair in POSE_PAIRS:
            ...
            if points[partA] and points[partB]:
                ...
                #cv2.putText(frame, str(points[partA]), points[partA], cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, lineType=cv2.LINE_AA)
            ...
            if xy_1 != () and xy_8 != () :
                angle = getAngle3P(xy_1, xy_14, xy_8)
                #print(angle)
                #cv2.putText(frame, str(round(angle,2)), xy_14, cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, lineType=cv2.LINE_AA)
                
                if angle>100 and angle < 165:
