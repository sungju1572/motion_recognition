    ...
    def proc(self, module, video):
        ...
        while cv2.waitKey(1) < 0:
            ...
            for pair in POSE_PAIRS:
                ...
                if partA == 14 and partB == 11:
                        xy_1 = points[partA]
                        xy_14 = points[partB]
                         
                elif partA == 11 and partB == 12:
                        xy_8 = points[partB]
                        
                if xy_1 != () and xy_8 != () and xy_14 != ():
                    angle = self.getAngle3P(xy_1, xy_14, xy_8)
                    cv2.putText(frame, str(round(angle,2)), xy_14, cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, lineType=cv2.LINE_AA)
                    xy_1 = ()
                    xy_8 = ()
                    xy_14 = ()
                    if angle>145 and angle < 190:
                        cv2.putText(frame, "GOOD", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1.8, (0, 50, 255), 2, lineType=cv2.LINE_AA)
                    else:
                        cv2.putText(frame, "BAD", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1.8, (255, 50, 0), 2, lineType=cv2.LINE_AA)
